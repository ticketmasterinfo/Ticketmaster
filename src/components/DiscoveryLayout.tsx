...
import { Filter, Calendar, Tag, ShieldCheck, Ticket, Check, RotateCcw, Flame } from 'lucide-react';
  ...
  return (
    <section id="discovery-section" className="py-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        {/* Left: Filter Sidebar */}
        <aside className="w-full lg:w-72 bg-white rounded-lg border border-[#ebebeb] p-5 shadow-xs shrink-0">
        ...
        {/* Right: Filtered Event List Stream */}
        <div className="flex-1 w-full space-y-4">
          <div className="flex items-center justify-between bg-white px-5 py-3 rounded-lg border border-[#ebebeb] shadow-xs">
          ...
          {events.length === 0 ? (
            <div className="bg-white rounded-lg border border-[#ebebeb] p-12 text-center shadow-xs">
              ...
              <button
                type="button"
                onClick={onResetFilters}
                className="mt-4 px-4 py-2 bg-[#024ddf] text-white rounded font-semibold text-sm hover:bg-[#0139a7] transition-colors"
              >
                Reset All Filters
              </button>
            </div>
            ...
            <div className="space-y-3">
              {events.map((event) => (
                <div
                  key={event.id}
                  className="bg-white rounded-lg border border-[#ebebeb] p-4 sm:p-5 shadow-xs hover:shadow-md hover:border-[#bfbfbf] transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-4 group"
                >
                  ...
                  <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-2 pt-3 sm:pt-0 border-t sm:border-t-0 border-[#ebebeb] shrink-0">
                    ...
                    <button
                      ...
                      className="type-fiji bg-[#024ddf] hover:bg-[#0139a7] active:bg-[#012e85] text-white px-5 py-2.5 rounded font-bold transition-all shadow-xs hover:shadow flex items-center gap-2"
                    >
